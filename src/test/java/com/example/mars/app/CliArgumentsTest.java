...
/**
 * Unit tests for CliArguments class, covering CLI argument parsing, validation, and boundary policy
...
class CliArgumentsTest {
  ...
  void parse_multipleBoundaryFlags_lastFlagWins() throws CliArgumentsException {
    ...
    CliArguments cli =
        CliArguments.parse(new String[] {"--strict", "--ignore-oob", "--stop-on-oob"});
  ...
  void parse_mixedValidInvalidFlags_invalidReported() {
    ...
    assertThatThrownBy(
            () -> CliArguments.parse(new String[] {"--strict", "--invalid", "--ignore-oob"}))
        .isInstanceOf(CliArgumentsException.class)
