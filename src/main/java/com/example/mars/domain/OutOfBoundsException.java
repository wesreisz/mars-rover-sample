 ...
 * 
 * <p>This exception is used by the mission execution system to signal when a rover
 * would move beyond the valid plateau coordinates, allowing different boundary policies
 * to handle such situations appropriately.</p>
 * 
...
public class OutOfBoundsException extends Exception {
     ...
     * 
     * @param message the detail message explaining the out-of-bounds condition,
     *                including rover identification and position context
     */
