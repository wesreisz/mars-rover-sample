...
/**
 * Main application class for the Mars Rover CLI. Provides command-line interface for parsing
 * rover mission input from STDIN and executing missions with configurable boundary policies.
 * 
 * <p>The application supports the following command-line flags:
 * <ul>
 *   <li>{@code --strict} - Fail on out-of-bounds moves (default)</li>
 *   <li>{@code --ignore-oob} - Skip out-of-bounds moves</li>
 *   <li>{@code --stop-on-oob} - Stop rover on out-of-bounds detection</li>
 *   <li>{@code --fail-fast} - Stop on first error (default)</li>
 *   <li>{@code --collect-errors} - Continue processing after errors</li>
 * </ul>
 * 
 * <p>Exit codes:
 * <ul>
 *   <li>0 - Success</li>
 *   <li>1 - Validation or execution error</li>
 *   <li>2 - Usage error (invalid command-line arguments)</li>
 * </ul>
 * 
 * <p>Input is read from STDIN and should follow the mission format:
 * <ol>
 *   <li>Plateau upper-right coordinates: "maxX maxY"</li>
 *   <li>For each rover:
 *     <ul>
 *       <li>Starting position: "x y heading" (heading ∈ {N,E,S,W})</li>
 *       <li>Instructions: sequence of L, R, M commands</li>
 *     </ul>
 *   </li>
 * </ol>
 * 
