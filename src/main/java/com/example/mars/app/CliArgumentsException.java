...
/**
 * Exception thrown when CLI argument parsing fails due to invalid or unknown arguments.
 * This exception is used to signal usage errors that should result in exit code 2.
 * 
 * <p>Common scenarios that trigger this exception include:
 * <ul>
 *   <li>Unknown command-line flags</li>
 *   <li>Conflicting boundary policy flags</li>
 *   <li>Invalid flag formats or values</li>
 * </ul>
 */
